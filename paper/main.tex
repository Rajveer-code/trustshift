...
figures from the committed prediction files---are available as an open-source repository at
\url{https://github.com/Rajveer-code/trustshift}, and the harmonized benchmark of standardized
predictions is on the Hugging Face Hub at
\url{https://huggingface.co/datasets/Rajveer-code/trustshift}. All source datasets are public
(NHANES, BRFSS, HMDA, GoEmotions, CIC-DDoS2019, CICIDS2017); consistent with their licenses we
redistribute standardized model predictions and metadata, not raw third-party records. Seeds,
estimator settings, and metric definitions are fixed in the released configuration.
