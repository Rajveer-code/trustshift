...
\author{Rajveer Singh Pall\\[2pt]
\normalsize Department of Computer Science and Business Systems\\
\normalsize Gyan Ganga Institute of Technology and Sciences, Jabalpur, Madhya Pradesh, India\\
\normalsize \texttt{rajveerpall04@gmail.com}\ \ $\cdot$\ \ ORCID: 0009-0001-6763-6124}
\date{}
...
\begin{itemize}
  ...
  \item \textbf{A released benchmark.} Four harmonized shift-pairs, standardized predictions, and
...
\paragraph{Funding.} No funding was received to assist with the preparation of this manuscript.

\paragraph{Competing interests.} The author declares no competing interests.

\paragraph{Ethics approval.} Not applicable. This study uses only publicly available, de-identified
datasets and involves no new human- or animal-subjects data collection.

\paragraph{Author contributions.} Rajveer Singh Pall is the sole author and conducted all aspects of
the work: conception, methodology, experiments, analysis, and writing.

\paragraph{Data availability statement.} All source datasets are public: NHANES and BRFSS
(U.S.\ Centers for Disease Control and Prevention), HMDA (U.S.\ Consumer Financial Protection
Bureau), GoEmotions, CIC-DDoS2019, and CICIDS2017. Consistent with their licenses, the released
benchmark redistributes standardized model \emph{predictions} and metadata---not raw third-party
records. The harmonized benchmark of predictions is available on the Hugging Face Hub at
\url{https://huggingface.co/datasets/Rajveer-code/trustshift}.

\paragraph{Code availability.} The TrustShift protocol, the four domain adapters, the audit engine,
and every results file that backs a number in this paper---together with a single script that
regenerates all tables and figures from the committed prediction files---are available as an
open-source repository at \url{https://github.com/Rajveer-code/trustshift}. Seeds, estimator
settings, and metric definitions are fixed in the released configuration.
